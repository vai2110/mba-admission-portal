...
# Load only definitions; skip the original execution block so we can use a corrected renderer.
...
# Rebuild every SRMIST page with the deeper student-query sections.
...
filenames={
'btech-cse':'srmist-btech-cse.html','btech-ai':'srmist-btech-artificial-intelligence.html','btech-it':'srmist-btech-information-technology.html','btech-ece':'srmist-btech-ece.html','mba':'srmist-mba.html','mba-business-analytics':'srmist-mba-business-analytics.html','mba-financial-services-nse':'srmist-mba-financial-services-nse.html','mbbs':'srmist-mbbs.html','mca':'srmist-mca.html'}
for key,filename in filenames.items():
    (ROOT/filename).write_text(course_body(key),encoding='utf-8')

# Repair the malformed cross-link that was present in the old overview and validate all generated pages.
over=(ROOT/'srm-institute-science-technology.html').read_text(encoding='utf-8')
over=over.replace('srmist-btech-cse.html','srmist-btech-cse.html').replace('srmist-btech-artificial-intelligence.html','srmist-btech-artificial-intelligence.html').replace('srmist-btech-information-technology.html','srmist-btech-information-technology.html').replace('srmist-btech-ece.html','srmist-btech-ece.html').replace('srmist-mba.html','srmist-mba.html').replace('srmist-mba-business-analytics.html','srmist-mba-business-analytics.html').replace('srmist-mba-financial-services-nse.html','srmist-mba-financial-services-nse.html').replace('srmist-mbbs.html','srmist-mbbs.html').replace('srmist-mca.html','srmist-mca.html')
(ROOT/'srm-institute-science-technology.html').write_text(over,encoding='utf-8')
